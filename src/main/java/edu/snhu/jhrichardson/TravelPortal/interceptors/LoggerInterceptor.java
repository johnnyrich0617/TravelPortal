package edu.snhu.jhrichardson.TravelPortal.interceptors;
...
public class LoggerInterceptor extends HandlerInterceptorAdapter {
   ...
   private String getParameters(final HttpServletRequest request) {
       ...
       while (e != null && e.hasMoreElements()) {
           ...
           log.info("Parsing the Current Elelment: " + curr);
           posted.append(curr).append("=");
           if (curr.equals("password") || curr.contains("password") || curr.contains("answer") || curr.contains("pwd")) {
               posted.append("*****");
           } else {
               posted.append(request.getParameter(curr));
           }
           log.info("Posting is now as read = " + posted.toString());
       }
